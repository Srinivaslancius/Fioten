                                            ...
                                            <div class="modal-dialog" Style="margin-top:10%;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body" >
                                                        <h5><b>User Name</b></h5><p><?php echo $row['user_name']."<br>";?>
                                                        <h5><b>User Email</b></h5><?php echo $row['user_email']."<br>";?>
                                                        <h5><b>User Mobile</b></h5><?php echo $row['user_mobile']."<br>";?>
                                                        <h5><b>User Address</b></h5> <?php echo $row['user_address']; ?> </p> 
                                                    </div>
